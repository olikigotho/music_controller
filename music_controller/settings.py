...
SECRET_KEY = 'django-insecure-cgw@=plj^b98bkq=mr+b9a9oyov=c=4^l$ef0o!9-yl0+ca95+'
...
# Added so chrome doesn't cache the code enabling watching
#
#
...
# Disable caching for dynamic content (optional)
